...
impl Plugin {
    ...
    async fn run_with<C: Cni, E: Env, I: Io>(&self, cni: &C) -> Result<(), Error> {
        ...
        match self.inner_run::<C, E, I>(cni).await {
            Ok(res) => {
...
mod tests {
    ...
    #[tokio::test]
    async fn test_plugin_inner_run_accepted(
        #[case] command: &str,
    ...
    #[case("0.4.0", Some("4"))]
    #[tokio::test]
    async fn test_plugin_inner_run_add_echoes_cni_version(
        #[case] version: &str,
    ...
    #[cfg(feature = "async")]
    #[tokio::test]
    async fn test_plugin_inner_run_unset_prints_help() -> Result<(), Error> {
        set_dispatch_env("", "", "", "");
    ...
    #[cfg(feature = "async")]
    #[tokio::test]
    async fn test_plugin_inner_run_unset_without_about_text_is_code_4() {
        set_dispatch_env("", "", "", "");
        let result = Plugin::default()
            .inner_run::<MockCni, MockEnv, MockIo>(&MockCni)
            .await;
        assert!(
    ...
    #[tokio::test]
    async fn test_plugin_inner_run_env_matrix_rejected(
        #[case] command: &str,
        ...
        match dispatch_with_env(command, container_id, netns, ifname).await {
    ...
    #[tokio::test]
    async fn test_plugin_run_writes_stdout(
        #[case] container_id: &str,
        ...
        let result = Plugin::default()
            .run_with::<MockCni, MockEnv, MockIo>(&MockCni)
            .await;
    ...
    #[tokio::test]
    async fn test_plugin_inner_run_env_matrix_accepted(
        #[case] command: &str,
        #[case] container_id: &str,
        #[case] netns: &str,
        #[case] ifname: &str,
    ) -> Result<(), Error> {
        dispatch_with_env(command, container_id, netns, ifname).await?;
        Ok(())
    }
    ...
    #[tokio::test]
    async fn test_plugin_inner_run_version_rejected(
        #[case] plugin: Plugin,
        #[case] command: &str,
        #[case] config_version: &str,
        ...
        match plugin.inner_run::<MockCni, MockEnv, MockIo>(&MockCni).await {
    ...
    #[tokio::test]
    async fn test_plugin_inner_run_missing_cni_version(
        #[case] plugin: Plugin,
